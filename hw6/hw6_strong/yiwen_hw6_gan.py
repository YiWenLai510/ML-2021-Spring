...
# os.system(f'unzip -q {workspace_dir}/crypko_data.zip -d {workspace_dir}/')
...
log_dir = os.path.join(workspace_dir, 'logs_sngan_magic1')
ckpt_dir = os.path.join(workspace_dir, 'checkpoints_sngan_magic1')
...
os.makedirs('output_sngan_magic1', exist_ok=True)
for i in range(1000):
    torchvision.utils.save_image(imgs_sample[i], f'output_sngan_magic1/{i+1}.jpg')
  
# Compress the images.
# %cd output
# os.system('tar -zcf ../images_wgan.tgz *.jpg') 
# %cd ..